        ...
        <div>
            <Layout>
                ...
                <div className={aboutStyles.description}>
                    ...
                    "<a className={aboutStyles.link} href="https://www.udemy.com/course/100-days-of-code/" target="_blank" rel="noreferrer">100 Days of Code</a>" Python Bootcamp to build various projects in Web App Development, Desktop App Development, Automation, Web Scraping, Gaming, and Data Science using Python. Both of these courses have been excellent for a beginner like myself, and have helped build a solid base of knowledge and confidence that I can learn from any resource.
                    </p>

                    <p>
                    Right now, I would like to gain exposure to many different areas inside and outside of programming - especially Engineering, Web App Development, Desktop App Development, Automation, Project Assistance, and Data Exploration and Visualization. Once I gain enough experience in these different areas, hopefully I will have found a role that I like and begin to grow into that specific role. Eventually, I would like to further expand my skill set by learning about other languages like Ruby on Rails and R, and build simple projects that would tie into my passions. 
                    </p>
                    
                    <p>
                    In my spare time, I am an avid fan of Hockey, Basketball, and Mixed Martial Arts. I also love Photoshop, Poker, biking, long walks, board games, game shows, sitcoms, reality TV, and trying different kinds of food. I am always seeking completed projects on these topics for inspiration on new project ideas in the future. I also enjoy volunteering for organizations like Sport Calgary, which gives children an opportunity to discover a new sport and promotes active living.
                    </p>
